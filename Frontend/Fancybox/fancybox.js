    ...
    var Q = {ScrollLock: B, Thumbs: H, Html: j, Image: X, Hash: V, Toolbar: J}, tt = {
        ...
        return s(i, [{
            ...
            key: "initLayout", value: function () {
                ...
                var e = this.option("template_admin.main");
            ...
            key: "manageCloseButton", value: function (t) {
                ...
                if (i && ("top" !== i || !this.$closeButton)) {
                    ...
                    n.classList.add("carousel__button", "is-close"), n.setAttribute("title", this.options.l10n.CLOSE), n.innerHTML = this.option("template_admin.closeButton"), n.addEventListener("click", (function (t) {
                        return e.close(t)
            ...
            key: "showLoading", value: function (t) {
                ...
                i || ((i = document.createElement("div")).classList.add("fancybox__spinner"), i.innerHTML = this.option("template_admin.spinner"), i.addEventListener("click", (function () {
